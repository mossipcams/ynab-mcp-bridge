...
export const description =
  "Gets a single plan month snapshot. Returns a compact summary by default, with an explicit full-view opt-in.";
...
export async function execute(
  input: { planId?: string; month?: string; view?: "compact" | "full" },
  api: ynab.API,
) {
  try {
