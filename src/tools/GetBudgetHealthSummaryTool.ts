...
export const description =
  "Returns a compact budget health summary with available funds, overspending, underfunding, and assigned versus spent, where assigned versus spent reflects buffering behavior and is not a discipline score.";
