...
export const description =
  "Gets a single payee by ID. Returns a compact projection by default, with an explicit full-view opt-in.";
...
export async function execute(
  input: { planId?: string; payeeId: string; view?: "compact" | "full" },
  api: ynab.API,
) {
  try {
