...
export const description =
  "Gets a single account by ID. Returns a compact projection by default, with an explicit full-view opt-in.";
...
export async function execute(
  input: { planId?: string; accountId: string; view?: "compact" | "full" },
  api: ynab.API,
) {
  try {
