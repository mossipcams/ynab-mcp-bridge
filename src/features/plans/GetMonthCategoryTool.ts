...
export const description =
  "Gets a single category for a specific month. Returns a compact projection by default, with an explicit full-view opt-in.";
...
export async function execute(
  input: { planId?: string; month: string; categoryId: string; view?: "compact" | "full" },
  api: ynab.API,
) {
  try {
