export type ReliabilityProfileName = "smoke" | "baseline" | "stress" | "spike" | "soak";
...
type LoadProfile = {
  ...
  name: Exclude<ReliabilityProfileName, "smoke">;
  runner: "load";
  thresholds: ReliabilityThresholdTargets;
};

export type ReliabilityProfile = SmokeProfile | LoadProfile;

const RELIABILITY_PROFILES: Record<ReliabilityProfileName, ReliabilityProfile> = {
  smoke: {
...
export function getReliabilityProfile(name: ReliabilityProfileName) {
