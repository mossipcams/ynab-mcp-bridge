...
function getRedirectUrisError(redirectUris) {
...
function getUnsupportedClientMetadataFieldError(client) {
...
function getGrantTypeError(grantTypes) {
...
function getResponseTypeError(responseTypes) {
...
function getTokenEndpointAuthMethodError(tokenEndpointAuthMethod) {
...
function getClientMetadataValidationError(client) {
...
function getSingleStringError(value, fieldName, options = {}) {
...
export function parseClientMetadata(client) {
...
export function parseConsentRequestBody(body) {
    ...
    const consentChallengeError = getSingleStringError(result.data.consent_challenge, "consent_challenge", { missingMessage: "Missing consent challenge." });
    if (consentChallengeError) {
        throw new InvalidRequestError(consentChallengeError);
    }
    return {
        action: toOptionalString(result.data.action),
        consentChallenge: toOptionalString(result.data.consent_challenge),
    };
}
