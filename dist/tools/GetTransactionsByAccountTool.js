...
export const execute = createIdFilteredTransactionCollectionExecutor(async (transactions, planId, accountId) => (await transactions.getTransactionsByAccount(planId, accountId, undefined, undefined, undefined)).data.transactions, "accountId");
