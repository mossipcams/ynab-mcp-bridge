import { z } from "zod";
import { assertTransactionMonth, buildTransactionCollectionResult, toDisplayTransactions, transactionFields, } from "../transactionQueryEngine.js";
...
export async function execute(input, api) {
    try {
        ...
        const response = await withResolvedPlan(input.planId, api, async (planId) => api.transactions.getTransactionsByMonth(planId, month, undefined, undefined, undefined));
        return toTextResult({
