import { z } from "zod";
import { buildTransactionCollectionResult, compareTransactions, matchesTransactionFilters, toDisplayTransactions, transactionFields, } from "../transactionQueryEngine.js";
...
export async function execute(input, api) {
    try {
        ...
        return toTextResult({
            ...buildTransactionCollectionResult(toDisplayTransactions(transactions), input, "match_count", {
